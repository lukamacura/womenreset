...
habit_strategy: |
  **Micro-Movement Momentum** — Tiny morning movements build consistency and reduce stiffness.
  
  Keep a yoga mat by your bed; stretch before checking your phone.
  
  🧘 **Tip:** Stack movement with automatic habits like boiling the kettle.

follow_up_question: "Would you like to learn about anti-inflammatory eating in menopuase?"
follow_up_links:
  -persona: "nutrition"
...
intent_patterns:
  ...
  - "How do I make mornings easier on my achy body?"
...
keywords:
    - "morning stiffness"
    - "wake-up mobility"
    - "first thing joint pain routine"
    - "morning joint pain"
    ...
    - "simple morning routine I can actually do for joint pain and stiffness"
---